...
// }
//
// let tripledArray = originalArray.map(tripleFunction)


let tripledArray = originalArray.map(tripleFunction = num => num * 3);
...
//
let oddOrEven = originalArray.map(num => (num % 2 === 0 ? 'even' : 'odd'));
//
